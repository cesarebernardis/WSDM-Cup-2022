            ...
            for folder in EXPERIMENTAL_CONFIG['datasets']:
                if exam_folder in folder:
                    ...
                    for normalize in [True, False]:
                        ...
                        featgen.load_catboost_ensemble_feature(folder, normalize=normalize, break_ties=True, algo_suffix="-small")
                        featgen.load_catboost_ensemble_feature(folder, normalize=normalize, break_ties=True, algo_suffix="-small-nonorm", featname_suffix="-nonorm")
                        featgen.load_catboost_ensemble_feature(folder, normalize=normalize, break_ties=True, algo_suffix="-small-both", featname_suffix="-both")
