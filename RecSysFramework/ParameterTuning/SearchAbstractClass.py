...
class SearchAbstractClass(object):
    ...
    def _evaluate_on_validation(self, current_fit_parameters):
        ...
        if self.is_early_stopping:
            ...
            result_dict = metric_handler.get_results_dictionary(use_metric_name=False)
    ...
    def _objective_function(self, current_fit_parameters_dict):
        ...
        try:
            ...
            current_result = self._calculate_metric_to_optimize(result_dict)
            ...
            if self.metadata_dict["result_on_validation_best"] is None:
                ...
                best_solution_val = self._calculate_metric_to_optimize(self.metadata_dict["result_on_validation_best"])
