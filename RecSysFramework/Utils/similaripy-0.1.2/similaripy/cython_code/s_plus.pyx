...
cdef extern from "coo_to_csr.h" nogil:
    void coo32_to_csr64(int n_row,int n_col,long long nnz,int Ai[],int Aj[],float Ax[],long long Bp[],long long Bj[],float Bx[])
...
def s_plus(
    ...
    cdef long long [:] indices64, indptr64
